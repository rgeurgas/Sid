...
urlpatterns = [
    ...
    re_path(r'^course/\d+/forum/$', views.post_list, name='post_list'),
    re_path(r'^course/\d+/forum/(?P<pk>\d+)/$', views.post_detail, name='post_detail'),
    re_path(r'^course/\d+/forum/new/$', views.post_new, name='post_new'),
    re_path(r'^course/\d+/forum/(?P<pk>\d+)/edit/$', views.post_edit, name='post_edit'),
    re_path(r'^course/\d+/forum/(?P<pk>\d+)/remove/$', views.post_remove, name='post_remove'),
    re_path(r'^course/\d+/forum/\d/(?P<pk>\d+)/remove$', views.comment_remove, name='comment_remove')
